...
url(r'v1/list/categories', views.categorieslist, name='categorieslist'),
url(r'v1/list/subcategories/(?P<catid>\d+)', views.listcategoriesbyid, name='listcategoriesbyid'),
...
url(r'v1/subscription', views.subscription, name='subscription'),
url(r'v1/subscription/completed', views.subscriptioncompleted, name='subscriptioncompleted'),
