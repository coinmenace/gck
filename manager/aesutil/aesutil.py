...
if __name__=="__main__":
    password="admin34234567890"
    #f1=open("sample.mp3","r+")
    #f2=open("sample_encrypted.mp3","w+")
    in_filename="sample.mp3"
    out_filename="sample_encrypted.mp3"
    encrypt_file(password, in_filename, out_filename, chunksize=64*1024)
    in_filename="sample_encrypted.mp3"
    out_filename="sample_new.mp3"
    decrypt_file(password, in_filename, out_filename, chunksize=24*1024)
    #encrypt(f1, f2, password, key_length=32)
    
    #f3=open("sample_encrpted.mp3","r+")
    #f4=open("sample_new.mp3","w+")
    #decrypt(f3, f4, password, key_length=32)
